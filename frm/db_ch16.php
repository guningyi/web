...
$sql = 'INSERT IGNORE INTO frm_admin
    ...
    VALUES
        ...
        (NULL, "Board Description", "The place to discuss your favorite ' .
        'comic books, movies and more!", "description"),
        (NULL, "Admin Email", "admin@example.com", "admin_email"),
        (NULL, "Copyright", "&copy; Comic Book Appreciation, Inc.  All ' .
...
$sql = 'INSERT IGNORE INTO frm_forum
    ...
    VALUES
        (NULL, "New Forum", "This is the initial forum created when ' .
        'installing the database.  Change the name and the ' .
        'description after installation.", 1)';
mysql_query($sql, $db) or die(mysql_error($db));
...
$sql = 'INSERT IGNORE INTO frm_posts 
    ...
    VALUES
        (1, 0, 1, 1, 0, "' . date('Y-m-d H:i:s') . '", 0, "Welcome",
        "Welcome to your new Bulletin Board System.  Do not forget to ' .
        'change your admin password after installation.  Have fun!")';
mysql_query($sql, $db) or die(mysql_error($db));
...
$sql = 'INSERT IGNORE INTO frm_users
    ...
    VALUES
        (1, "Administrator", "admin@example.com", PASSWORD("secret"),
...
<html>
 <head>
  <title>Forum Tables Created</title>
 </head>
 <body>
 <h1>Comic Book Appreciation Forums</h1>
 <p>The following forum tables have been created:</p>
 <ul>
  <li>frm_admin</li>
 ...
 <p><a href="frm_login.php">Log In</a> to the site now.</p>
 </body>
</html>