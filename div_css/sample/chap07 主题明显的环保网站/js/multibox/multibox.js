...
var multiBox = new Class({
	...
	getContent: function(index)
	{
		...
		if(this.options.addDownload == true)//only if download is enabled in the top settings (liam)
		{
			...
			this.download.set('html','<a href=../../dynamicearth/www.dynamicearth.co.uk/Portals/ODE/script/multibox//"'+this.options.pathToDownloadScript+'?FilePath='+FilePath+'\" title="Download File '+FileName+'\">Download File</a>');//force download the file using ASP
		};
	...
	createEmbedObject: function()
	{
		...
		if(this.type == 'quicktime')
		{
			...
			this.str += '<embed src="../../dynamicearth/www.dynamicearth.co.uk/Portals/ODE/script/multibox/'+this.contentObj.url+'" autoplay="true" pluginspage="http://www.apple.com/quicktime/download/" width="'+this.contentObj.width+'" height="'+this.contentObj.height+'"></embed>';
			this.str += '<object/>';
		};
		...
		if(this.type == 'windowsMedia')
		{
			...
			this.str += '<embed type="application/x-mplayer2" src="../../dynamicearth/www.dynamicearth.co.uk/Portals/ODE/script/multibox/'+this.contentObj.url+'" Showcontrols="true" autoStart="true" width="'+this.contentObj.width+'" height="'+this.contentObj.height+'"></embed>';
			this.str += '<object/>';
		};
		...
		if(this.type == 'real')
		{
			...
			this.str += ' width="'+this.contentObj.width+'" height="'+this.contentObj.height+'">';
			this.str += '<param name="src" value="../../dynamicearth/www.dynamicearth.co.uk/Portals/ODE/script/multibox/'+this.contentObj.url+'" />';
			this.str += '<param name="controls" value="ImageWindow" />';
			this.str += '<param name="autostart" value="true" />';
			this.str += '<embed src="../../dynamicearth/www.dynamicearth.co.uk/Portals/ODE/script/multibox/'+this.contentObj.url+'" controls="ImageWindow" autostart="true" width="'+this.contentObj.width+'" height="'+this.contentObj.height+'"></embed>';
			this.str += '<object/>';
		};
		return obj;
	},
