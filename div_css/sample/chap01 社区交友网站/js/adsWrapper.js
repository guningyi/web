...
document.write('<script type="text/javascript" src="../tings/ar.atwola.com/file/'+adsUACH+adsUACN[0]+'"></scr','ipt>')
}else{
if (window.adsIn!=1){
adsIn=1
...
s+=inc+adsATOth+adsSrAT+adsATWM+adsTable+adsDL+"kvmn="+m+";target=_blank;"+adsTzAT+"grp="+adsScr+";misc="+adsScr
